...
sed -i "\#<liberty.runtime.version>22.0.0.2</liberty.runtime.version>#c<install><runtimeUrl>https://public.dhe.ibm.com/ibmdl/export/pub/software/openliberty/runtime/nightly/$DATE/$DRIVER</runtimeUrl>" pom.xml
cat pom.xml
