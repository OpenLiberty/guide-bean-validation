...
Next, create a service that can be used to programmatically validate the constraints
...
The [hotspot=beanValidation file=2]`beanValidation-2.0` feature definition enables the bean validation feature in the
