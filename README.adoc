...
You'll explore how to use Bean Validation in Open Liberty to create a microservice 
to validate data.
...
microservice. Feel free to give it a try before you proceed with building your own.

To try out the microservice, first navigate to the `finish` directory and then execute 
the following Maven goals to build the microservice and run it inside Open Liberty:
