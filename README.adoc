...
[hotspot=27 file=1]`serialNumber`, and [hotspot=24 file=1]`destination`. The JavaBean 
...
and [hotspot=24 file=1]`@Positive` annotations constrain the [hotspot=24 file=1]`destination` 
...
apply the custom constraint. Because the [hotspot=27 file=0]`SerialNumber` constraint is 
...
The [hotspot=27 file=1]`@Constraint` annotation specifies the class that contains the 
...
* The [hotspot=112-101 file=0]`testNoMethodLevelConstraintViolations` test case verifies 
